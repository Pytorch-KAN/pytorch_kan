...
from ..basis.orthogonal import SmoothActivationBasis
from .base import GlobalControlKANLayer


class SmoothActivationKANLayer(GlobalControlKANLayer):
    """KAN layer using smooth activation function basis with global control."""
    ...
    def __init__(
        ...
        self.activation_calc = SmoothActivationBasis(
            activation_type=activation_type, alpha=alpha, beta=beta
        )
